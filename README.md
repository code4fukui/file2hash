...
- Displays the length of the input file in bytes
- Allows users to drag and drop files to be hashed

## Requirements
This application runs in the browser and does not have any external dependencies.

## Usage
1. Visit the [demo site](https://code4fukui.github.io/file2hash/)
2. Drag and drop a file onto the page
